...
TELEGRAM_CHAT_ID = os.environ.get("TELEGRAM_CHAT_ID") # The main Group ID (starts with -100 usually)

# Define your logic here
RULES = {
    "active_orgs": {
        "names": ["deepchem", "google-deepmind", "keras-team"],
        "filters": "", # No extra filters, we want everything
        "topic_id": 2, # REPLACE with your "Urgent Work" Topic ID
        "label": "🔥 URGENT"
    },
    "passive_orgs": {
        "names": ["Cloud-CV", "cBioPortal", "opencv", "kornia"],
        "filters": "label:\"good first issue\",\"help wanted\"", # Only these labels
        "topic_id": 3, # REPLACE with your "Good First Issues" Topic ID
        "label": "🌱 EASY"
    }
}
...
def send_telegram(issue, rule_config):
    ...
    payload = {
        ...
        "text": msg,
        "parse_mode": "HTML",
        "message_thread_id": rule_config['topic_id'] # This directs it to the specific topic
    }
